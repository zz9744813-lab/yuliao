...
**并集 1672**（train_entry 实跑：按行数相加会虚增 1672，不许）。
三件重导出验收全 PASS（重合 0/冲突 0/缺键 0/未校勘 0/比较文本
6111/6111/1719），manifest 落 data/exports/（gitignore 外置，可重跑
验收器再生）。回归 8 测。审查剩余：5 项 P1 / 3 项 P2 排队中。
